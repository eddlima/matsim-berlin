...
#SBATCH --job-name=SiBa+v2-10min-10pct
...
config="${RUN_CONFIG:-../v6.4/berlin-v6.4-SiBa+v2.config.xml}"

arguments="--10pct --config:controller.outputDirectory ../../output-SiBa+v2-10pct"
