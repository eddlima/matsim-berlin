...
#SBATCH --job-name=Base_Case-10min-10pct
...
config="${RUN_CONFIG:-../v6.4/berlin-v6.4-Base_Case.config.xml}"

arguments="--10pct --config:controller.outputDirectory ../../output-Base_Case-10pct"
