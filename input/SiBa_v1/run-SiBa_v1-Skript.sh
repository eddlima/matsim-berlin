...
#SBATCH --job-name=SiBa_v1-10min-10pct
...
config="${RUN_CONFIG:-../v6.4/berlin-v6.4-SiBa_v1.config.xml}"

arguments="--10pct --config:controller.outputDirectory ../../output-SiBa_v1-10pct"
