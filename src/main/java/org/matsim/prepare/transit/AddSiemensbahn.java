...
//		var stop13_bus_e_w=scheduleFactory.createTransitRouteStop(stop13_bus_facility_e_w,954,964);
		...
		stop8_e_w.setAwaitDepartureTime(true);
			//SiBa+v1 //SiBa+v2
		stop9_e_w.setAwaitDepartureTime(true);
		stop10_e_w.setAwaitDepartureTime(true);
//		//Bus
//		stop01_bus_e_w.setAwaitDepartureTime(true);
//		stop02_bus_e_w.setAwaitDepartureTime(true);
//		stop03_bus_e_w.setAwaitDepartureTime(true);
//		stop04_bus_e_w.setAwaitDepartureTime(true);
//		stop05_bus_e_w.setAwaitDepartureTime(true);
//		stop06_bus_e_w.setAwaitDepartureTime(true);
//		stop07_bus_e_w.setAwaitDepartureTime(true);
//		stop08_bus_e_w.setAwaitDepartureTime(true);
//		stop09_bus_e_w.setAwaitDepartureTime(true);
//		stop10_bus_e_w.setAwaitDepartureTime(true);
//		stop11_bus_e_w.setAwaitDepartureTime(true);
//		stop12_bus_e_w.setAwaitDepartureTime(true);
//		stop13_bus_e_w.setAwaitDepartureTime(true);
...
//		var stop13_bus_w_e=scheduleFactory.createTransitRouteStop(stop13_bus_facility_w_e,954,964);
		...
		stop8_w_e.setAwaitDepartureTime(true);
			//SiBa+v1 //SiBa+v2
		stop9_w_e.setAwaitDepartureTime(true);
		stop10_w_e.setAwaitDepartureTime(true);
//		//Bus
//		stop01_bus_w_e.setAwaitDepartureTime(true);
//		stop02_bus_w_e.setAwaitDepartureTime(true);
//		stop03_bus_w_e.setAwaitDepartureTime(true);
//		stop04_bus_w_e.setAwaitDepartureTime(true);
//		stop05_bus_w_e.setAwaitDepartureTime(true);
//		stop06_bus_w_e.setAwaitDepartureTime(true);
//		stop07_bus_w_e.setAwaitDepartureTime(true);
//		stop08_bus_w_e.setAwaitDepartureTime(true);
//		stop09_bus_w_e.setAwaitDepartureTime(true);
//		stop10_bus_w_e.setAwaitDepartureTime(true);
//		stop11_bus_w_e.setAwaitDepartureTime(true);
//		stop12_bus_w_e.setAwaitDepartureTime(true);
//		stop13_bus_w_e.setAwaitDepartureTime(true);

		//route
		//S-Bahn
		var route_e_w = scheduleFactory.createTransitRoute(Id.create("SiBa+v2_e_w", TransitRoute.class),
		...
		var route_w_e = scheduleFactory.createTransitRoute(Id.create("SiBa+v2_w_e", TransitRoute.class),
...
//				stop09_bus_w_e,stop10_bus_w_e,stop11_bus_w_e,stop12_bus_w_e,stop13_bus_w_e),"pt");
		...
		for (int i = 3 * 3600; i < 24 * 3600; i += 600) {
			...
			var vehicle = scenario.getTransitVehicles().getFactory().createVehicle(Id.createVehicleId("SiBa+v2_vehicle_e_w_" + "100" + i), vehicleTypeSBahn);
...
//		}
		...
		for (int i = 3 * 3600; i < 24 * 3600; i += 600) {
			var departure = scheduleFactory.createDeparture(Id.create("departure_" + i, Departure.class), i);
			var vehicle = scenario.getTransitVehicles().getFactory().createVehicle(Id.createVehicleId("SiBa+v2_vehicle_w_e_" + "100" + i), vehicleTypeSBahn);
			departure.setVehicleId(vehicle.getId());
...
//		}
		...
		// line E > W
		//S-Bahn
		var line_e_w = scheduleFactory.createTransitLine(Id.create("SiBa+v2_e_w", TransitLine.class));
...
//		scenario.getTransitSchedule().addTransitLine(line_bus_e_w);
		...
		// line W > E
		//S-Bahn
		var line_w_e = scheduleFactory.createTransitLine(Id.create("SiBa+v2_w_e", TransitLine.class));
...
//		scenario.getTransitSchedule().addTransitLine(line_bus_w_e);
		...
		new NetworkWriter(network).write(root.resolve("berlin-v6.4-network-SiBa+v2-10min.xml.gz").toString());
		new TransitScheduleWriter(scenario.getTransitSchedule()).writeFile(root.resolve("berlin-v6.4-transitSchedule-SiBa+v2-10min.xml.gz").toString());
		new MatsimVehicleWriter(scenario.getTransitVehicles()).writeFile(root.resolve("berlin-v6.4-transitVehicles-SiBa+v2-10min.xml.gz").toString());
	}
